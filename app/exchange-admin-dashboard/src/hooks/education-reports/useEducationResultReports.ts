...
import { attemptGetEducationResultReports } from '../../api/EducationReportsApi';
...
export const fetchEducationReports = (params: any) => {
    return attemptGetEducationResultReports (params).then((res) => {
      return res.data
    });
  }

  export const useEducationResultReports = (params: any) => {
