...
import { attemptSendReturnsEmail } from '../../api/ClientReturnsApi';
...
export const sendReturnsEmail = (data: any) =>{
    return attemptSendReturnsEmail(data).then((res) => res.data);
}

export const useSendReturnsEmail = () => {
