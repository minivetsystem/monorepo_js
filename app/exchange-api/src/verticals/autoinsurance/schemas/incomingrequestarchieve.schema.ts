...
export type IncomingRequestArchieveDocument = HydratedDocument<IncomingRequestArchieve>;

@Schema({ versionKey: false })
export class IncomingRequestArchieve {
  ...
  @Prop()
  post_client_response_payload: string;

  @Prop()
  status: string;
}

export const IncomingRequestArchieveSchema = SchemaFactory.createForClass(IncomingRequestArchieve);
