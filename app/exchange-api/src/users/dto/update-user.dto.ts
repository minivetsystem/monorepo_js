...
import { LeadTypeSettingDto } from './leadtypesetting.dto';
import { VendorSubIdDto } from './vendor-subid.dto';
...
export class UpdateUserDto {
  ...
  @ApiProperty()
  lead_type_settings: LeadTypeSettingDto[];

  @ApiProperty()
  vendor_subids: VendorSubIdDto[];
